...
<?php include("./template/header.php")?>
    ...
    <?php include("./template/sidebook.php")?>
...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE `$tablename` SET `DATE` = :data WHERE `id` =  :id";
    $stmt = $con->prepare($query);
    $stmt->bindParam(':data', $data);
    $stmt->bindParam(':id', $id);

    if ($stmt->execute()) {
        echo"<script> window.location.href='timingsindex.php?iddb=$iddb&mid=$mid&nama=<?php echo $namas?>';</script>";
    } else {
